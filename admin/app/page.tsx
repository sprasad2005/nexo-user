    ...
    <>
      <div className="flex h-screen overflow-hidden bg-slate-50 text-slate-900 font-sans antialiased">
        ...
        <div className="flex-1 flex flex-col min-w-0 h-screen overflow-hidden">
          ...
          {/* Page Content */}
          <main className="p-4 sm:p-6 md:p-8 flex-1 max-w-6xl w-full mx-auto overflow-y-auto">
      ...
      {/* GLOBAL ADD IPO DRAWER — outside flex container so fixed overlay anchors to viewport */}
      <AddIPODrawer
        isOpen={isDrawerOpen}
