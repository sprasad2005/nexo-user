                                ...
                                {app.memberAvatar ? (
                                  <img
                                    ...
                                    onError={(e) => {
                                      ...
                                      (e.currentTarget.parentElement as HTMLElement).dataset.showInitial = "true";
                                    }}
                                  />
                                ) : (
      ...
      {isUrlModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-xs select-none animate-in fade-in duration-200">
          <form
            onSubmit={(e) => {
              e.preventDefault();
              if (!isSavingRegistrarUrl) handleSaveRegistrarUrl();
            }}
            className="bg-white dark:bg-[#101114] border border-slate-200 dark:border-[#252931] rounded-2xl max-w-md w-full p-6 shadow-2xl space-y-5"
          >
