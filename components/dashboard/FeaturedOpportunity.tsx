...
export function FeaturedOpportunity({ ipo, onApply }: FeaturedOpportunityProps) {
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pb-3 border-b border-line/70">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <div className="text-left text-h4 font-bold text-ink tracking-tight block leading-snug">
                {ipo.name}
              </div>
